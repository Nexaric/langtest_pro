...
class FormalLetterLesson3 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const FormalLetterLesson3({super.key, required this.lessonData});

  @override
  State<FormalLetterLesson3> createState() => _FormalLetterLesson3State();
}

class _FormalLetterLesson3State extends State<FormalLetterLesson3>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'You saw a job advertisement and want to apply. Write a letter to the company introducing yourself and explaining why you are suitable.',
    'sampleAnswer': '''
📝 Sample Answer

Dear Hiring Manager,

I am writing to apply for the position of Marketing Assistant advertised on your website. I am a recent graduate with a Bachelor’s degree in Marketing and two years of internship experience in digital advertising.

During my time at XYZ Agency, I managed several social media campaigns and contributed to a 20% increase in client engagement. I am confident that my creativity, organizational skills, and enthusiasm make me a strong fit for this role.
...
1. Structure:
   ...
   - Receiver Address: Company or hiring manager
   - Salutation: Use "Dear Hiring Manager" or specific name
   - Body: State position, qualifications, call to action
...
3. Content:
   - Specify the job and source of advertisement
   - Highlight relevant skills and experience
   - Include a request for further discussion
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/formal_letter_3.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Excellent job application! Your letter is professional, clear, and persuasive.";
    } else if (score >= 6.0) {
      return "Good effort. Include more specific qualifications or maintain a formal tone.";
    } else {
      return "Needs improvement. Focus on relevant skills and a confident tone.";
    }
  }
