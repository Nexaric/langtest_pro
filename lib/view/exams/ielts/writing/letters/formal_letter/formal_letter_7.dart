...
class FormalLetterLesson7 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const FormalLetterLesson7({super.key, required this.lessonData});

  @override
  State<FormalLetterLesson7> createState() => _FormalLetterLesson7State();
}

class _FormalLetterLesson7State extends State<FormalLetterLesson7>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'You missed an important meeting with a client due to a scheduling error. Write a formal letter to the client apologizing for the mistake and proposing a new meeting time.',
    'sampleAnswer': '''
📝 Sample Answer

Dear Ms. Thompson,

I am writing to sincerely apologize for missing our scheduled meeting on 15th May due to an unfortunate scheduling error on my part. I deeply regret any inconvenience this may have caused you.

To rectify this, I would like to propose a new meeting on 22nd May at 10:00 AM. Please let me know if this time is convenient, or I am happy to adjust to your availability.
...
1. Structure:
   ...
   - Receiver Address: Client’s name or title
   - Salutation: Use "Dear [Client’s Name]" or "Dear Sir/Madam"
   - Body: Apologize, explain briefly, propose solution
   - Closing: Use "Yours sincerely" or "Yours faithfully"

2. Tone:
   - Be sincere and professional
   - Avoid defensive or overly casual language

3. Content:
   - Acknowledge the mistake clearly
   - Provide a brief explanation without excuses
   - Offer a solution (e.g., rescheduling)
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/formal_letter_7.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Excellent apology letter! Your letter is sincere, professional, and well-structured.";
    } else if (score >= 6.0) {
      return "Good effort. Ensure your apology is clear and propose a specific solution.";
    } else {
      return "Needs improvement. Focus on sincerity and offering a concrete resolution.";
    }
  }
