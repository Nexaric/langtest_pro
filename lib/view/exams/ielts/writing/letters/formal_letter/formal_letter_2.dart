...
class FormalLetterLesson2 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const FormalLetterLesson2({super.key, required this.lessonData});

  @override
  State<FormalLetterLesson2> createState() => _FormalLetterLesson2State();
}

class _FormalLetterLesson2State extends State<FormalLetterLesson2>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'You recently bought an item online, but it arrived damaged. Write a letter to the company explaining the situation and asking for a refund or replacement.',
    'sampleAnswer': '''
📝 Sample Answer

Dear Customer Service Team,

I am writing to express my dissatisfaction with a product I recently ordered from your website. I purchased a wireless speaker (Order #A12345) on 10th May, but when it arrived on 15th May, I found it to be severely damaged.

The packaging was torn, and the speaker had several scratches and a broken power button, making it unusable. I have attached photographs for your reference.

I kindly request a full refund or a replacement as soon as possible. Please let me know how to proceed with the return.
...
1. Structure:
   - Sender Address: Your address (optional for complaints)
   - Date: Below your address or at the start
   - Receiver Address: Company or department name
   - Salutation: Use "Dear Customer Service Team" or specific contact
   - Body: State the issue, provide details, request action
...
3. Content:
   - Mention order details (e.g., order number, date)
   - Describe the issue clearly with evidence if possible
   - State your requested resolution (refund/replacement)
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/formal_letter_2.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Excellent complaint letter! Your letter is clear, polite, and well-structured.";
    } else if (score >= 6.0) {
      return "Good effort. Ensure your letter includes specific details or maintains a firmer tone.";
    } else {
      return "Needs improvement. Focus on providing clear details and a polite but firm tone.";
    }
  }
