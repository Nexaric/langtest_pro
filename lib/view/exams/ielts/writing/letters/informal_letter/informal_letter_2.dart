...
class InformalLetterLesson2 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const InformalLetterLesson2({super.key, required this.lessonData});

  @override
  State<InformalLetterLesson2> createState() => _InformalLetterLesson2State();
}

class _InformalLetterLesson2State extends State<InformalLetterLesson2>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'Your friend helped you move to a new apartment. Write a letter to thank them for their help.',
    'sampleAnswer': '''
📝 Sample Answer

Hey Lisa,

I just wanted to drop you a note to say a huge thank you for helping me move last weekend! You were a lifesaver with all those boxes.

It was so great having you there—not only for the heavy lifting but also for making it fun. I owe you big time! Fancy grabbing coffee this weekend? My treat, of course!
...
1. Structure:
   - Greeting: Start with a friendly "Hey [Name]"
   - Opening: Mention the reason for writing (to thank them)
   - Body: Specify what they did and why it mattered
   - Closing: Offer a gesture of appreciation (e.g., coffee) and sign off casually

2. Tone:
   - Be warm, sincere, and grateful
   - Use conversational language and contractions (e.g., "I’m", "you’re")

3. Content:
   - Be specific about their help (e.g., what they did)
   - Express how their help made a difference
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/informal_letter_2.json');
    } catch (e) {
  ...
  int _parseLessonId(dynamic id) {
    ...
    if (id is String) {
      ...
      return match != null ? int.parse(match.group(0)!) : 9; // Align with intId
    }
    return 9;
  }
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Wonderful thank-you letter! Your gratitude is clear, sincere, and heartfelt.";
    } else if (score >= 6.0) {
      return "Good effort. Be more specific about their help or add a personal gesture.";
    } else {
      return "Needs improvement. Focus on a sincere tone and specific details.";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'IELTS Writing: Informal Letter 2',
