...
class InformalLetterLesson6 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const InformalLetterLesson6({super.key, required this.lessonData});

  @override
  State<InformalLetterLesson6> createState() => _InformalLetterLesson6State();
}

class _InformalLetterLesson6State extends State<InformalLetterLesson6>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'You want to go on a weekend trip with a friend. Write a letter to suggest a destination and make plans.',
    'sampleAnswer': '''
📝 Sample Answer

Hey Emma,

How about a weekend trip to Brighton? It’d be awesome to chill by the beach!

I was thinking we could go next Saturday. We can take the morning train, spend the day exploring the pier, and grab some fish and chips. There’s a cool market too. I can book a B&B if you’re up for it. Let me know what you think!
...
1. Structure:
   ...
   - Opening: Suggest the trip idea enthusiastically
   - Body: Share details (destination, date, activities)
   - Closing: Ask for their thoughts and sign off casually

2. Tone:
   - Be excited, friendly, and inviting
   - Use conversational language and contractions

3. Content:
   - Propose a clear destination and plan
   - Include specific activities to make it appealing
   - Encourage their input or confirmation
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/informal_letter_6.json');
    } catch (e) {
  ...
  double _calculateScore(String text) {
    ...
    final wordScore = (wordCount / 90).clamp(0.0, 1.0) * 3;
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Great planning letter! Your trip idea is clear, engaging, and inviting.";
    } else if (score >= 6.0) {
      return "Good effort. Include more specific plans or a more enthusiastic tone.";
    } else {
      return "Needs improvement. Focus on clear plans and an inviting tone.";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'IELTS Writing: Informal Letter 6',
