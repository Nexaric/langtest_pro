...
class InformalLetterLesson3 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const InformalLetterLesson3({super.key, required this.lessonData});

  @override
  State<InformalLetterLesson3> createState() => _InformalLetterLesson3State();
}

class _InformalLetterLesson3State extends State<InformalLetterLesson3>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'You missed a friend’s important event. Write a letter to apologize and explain why you couldn’t attend.',
    'sampleAnswer': '''
📝 Sample Answer

Hi Mia,

I’m so sorry I missed your graduation party last weekend! I feel awful about it.

I got stuck at work with an urgent deadline and couldn’t leave until late. I really wanted to be there to celebrate with you. Can we meet up soon to hear all about it? Maybe dinner this Friday?

Sorry again, and congrats on graduating!
...
1. Structure:
   ...
   - Opening: Apologize sincerely and mention the event
   - Body: Explain why you couldn’t attend
   - Closing: Suggest making it up and sign off warmly

2. Tone:
   - Be sincere, regretful, and friendly
   - Use conversational language and contractions

3. Content:
   - Clearly state what you’re apologizing for
   - Give a genuine reason for your absence
   - Offer to make amends (e.g., meet up)
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/informal_letter_3.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Great apology! Your letter is sincere, clear, and offers a thoughtful way to make amends.";
    } else if (score >= 6.0) {
      return "Good effort. Provide a clearer reason or suggest a specific way to make up.";
    } else {
      return "Needs improvement. Focus on a sincere tone and a genuine explanation.";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'IELTS Writing: Informal Letter 3',
