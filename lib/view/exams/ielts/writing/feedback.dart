...
class FeedbackScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Hardcoded progress values for UI demonstration
    final writingProgress = 8; // Example value
    final letterProgress = 4; // Example value
    final totalProgress = writingProgress + letterProgress;
    final totalLessons = 40; // Example total lessons
    final totalWritingLessons = 25; // Example writing lessons
    final totalLetterLessons = 15; // Example letter lessons
                      ...
                      children: [
                        Expanded(
                          child: _buildProgressCard(
                            "Writing Lessons",
                            "$writingProgress / $totalWritingLessons",
                            Colors.blueAccent,
                          ),
                        ),
                        ...
                        Expanded(
                          child: _buildProgressCard(
                            "Letter Lessons",
                            "$letterProgress / $totalLetterLessons",
                            Colors.greenAccent,
                          ),
                        ),
                      ],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FadeIn(
                            ...
                            child: Text(
                              writingProgress < 10
                                  ? "Focus on completing more writing lessons to get detailed feedback."
                                  : letterProgress < 5
