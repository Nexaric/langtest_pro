...
class WritingLesson19 extends StatefulWidget {
  const WritingLesson19({super.key, required lessonData});
...
class _WritingLesson19State extends State<WritingLesson19>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Opinion Essay – Artificial Intelligence in Education',
    'icon': Icons.school,
    'question':
...
4. Examples:
   - Duolingo’s 30% retention boost
   - OECD’s 60% isolation report
