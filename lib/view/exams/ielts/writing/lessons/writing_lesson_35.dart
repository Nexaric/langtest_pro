...
class WritingLesson35 extends StatefulWidget {
  const WritingLesson35({super.key, required lessonData});

  @override
  State<WritingLesson35> createState() => _WritingLesson35State();
}

class _WritingLesson35State extends State<WritingLesson35>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Two-Part Question – Climate Change',
    'icon': Icons.cloud,
    'question':
...
Governments often resist climate action due to economic and political pressures. Fossil fuel industries, contributing 8% to global GDP, per a 2024 IEA report, wield significant influence. In the U.S., oil and gas lobbying reached 150 million in 2023, per OpenSecrets, delaying renewable transitions. Short-term economic costs also deter action; transitioning to net-zero by 2050 could cost 2% of global GDP annually, per a 2023 IMF estimate. Developing nations, like India, prioritize growth—coal powers 70% of its electricity, per a 2024 CEA report—over emissions cuts. Political inertia compounds this; populist leaders, as seen in Brazil’s 2023 deforestation surge, prioritize voter appeal over long-term goals.

Global strategies can counter these barriers. First, international agreements with enforcement mechanisms are vital. The Paris Agreement’s voluntary targets led to only 20% compliance, per a 2024 UNEP report, but a binding framework, like the EU’s carbon tariffs, could penalize non-compliance, raising 10 billion annually. Second, technology transfers to developing nations accelerate decarbonization. China’s solar panel exports cut costs by 30% in Africa, per a 2023 IRENA study. Third, global carbon pricing, as in Canada’s 50/ton levy, could generate 1 trillion by 2030, per OECD, funding green infrastructure.

Critics argue that stringent policies harm economies. Australia’s 2023 carbon tax repeal boosted GDP by 1%, per government data, suggesting flexibility is needed. However, inaction’s costs are higher—climate disasters cost 400 billion in 2024, per Munich Re. Developing nations also resist binding targets, citing historical emissions by richer countries, but equitable funding, like the 100 billion Green Climate Fund, addresses this.
...
4. Examples:
   - U.S. 150M lobbying
   - EU’s 10B carbon tariffs
   - Canada’s 50/ton levy
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_35.json');
    } catch (e) {
