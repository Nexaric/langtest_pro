...
class WritingLesson13 extends StatefulWidget {
  const WritingLesson13({super.key, required lessonData});

  @override
  State<WritingLesson13> createState() => _WritingLesson13State();
}

class _WritingLesson13State extends State<WritingLesson13>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Advantages/Disadvantages – Online Education',
    'icon': Icons.laptop,
    'question':
...
In conclusion, online education expands access but cannot fully replace traditional learning’s social and structured benefits. Hybrid approaches and infrastructure investment can bridge the gap, ensuring equitable, effective education.
''',
    'tips': '''
💡 Expert Tips
...
4. Examples:
   - Coursera’s global reach
   - Open University’s 60% lower fees
   - MOOCs’ 85% dropout rate
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_13.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.laptop, color: Colors.blue[700]),
