...
class WritingLesson6 extends StatefulWidget {
  const WritingLesson6({super.key, required lessonData});

  @override
  State<WritingLesson6> createState() => _WritingLesson6State();
}

class _WritingLesson6State extends State<WritingLesson6>
  ...
  final Map<String, dynamic> _task = {
    ...
    'sampleAnswer': '''
📝 Sample Answer (210 words)

Social media's impact on communication is profound. Benefits include instant global connectivity—families can video chat across continents, and activists mobilize movements like #MeToo rapidly. However, drawbacks like misinformation spread and cyberbullying are equally significant.
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_6.json');
    } catch (e) {
