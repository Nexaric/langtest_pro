...
class WritingLesson39 extends StatefulWidget {
  const WritingLesson39({super.key, required lessonData});

  @override
  State<WritingLesson39> createState() => _WritingLesson39State();
}

class _WritingLesson39State extends State<WritingLesson39>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Problem/Solution – Urban Overcrowding',
...
Urban overcrowding, a pressing global challenge, strains infrastructure and diminishes quality of life. With 56% of the world’s population living in cities in 2024, per UN data, understanding its causes and implementing solutions are critical to sustainable urban development.

The primary cause is rapid urbanization. Economic opportunities drive migration; cities like Mumbai generate 6% of India’s GDP, per a 2023 RBI report, attracting 1.5 million migrants annually. Inadequate rural infrastructure exacerbates this—only 40% of rural areas have reliable electricity, per a 2024 World Bank study, pushing people to urban centers. Population growth compounds the issue; sub-Saharan Africa’s urban population grew 4% yearly, per a 2023 UN-Habitat report. This overcrowding strains resources—70% of urban dwellers in developing nations lack adequate housing, per a 2024 UNICEF study—and fuels traffic congestion, with commute times in Jakarta doubling since 2015, per TomTom data.

Solutions include smart urban planning and decentralization. First, smart cities leverage technology; Singapore’s sensor networks cut water waste by 15%, per a 2023 government report. Second, decentralizing economic hubs reduces urban pressure. India’s Tier-2 cities, like Pune, attracted 10 billion in investments in 2024, per CBRE, easing Mumbai’s load. Third, affordable housing initiatives are vital; Vienna’s social housing program houses 60% of residents, per a 2024 OECD study, stabilizing rents. These measures enhance livability and distribute populations evenly.

Critics argue decentralization could weaken urban economies, as cities like Tokyo contribute 30% to Japan’s GDP, per a 2023 METI report. However, balanced regional development, as seen in Germany’s 2 billion rural investment plan, boosts national growth without urban reliance. Smart city costs—500 billion globally by 2030, per Bloomberg—are another concern, yet long-term savings, like Dubai’s 20% energy reduction, justify investments.
...
1. Structure:
   - Introduction: Highlight overcrowding’s impact, outline causes and solutions
...
4. Examples:
   - Mumbai’s 6% GDP contribution
   - Singapore’s 15% water waste reduction
   - Vienna’s 60% social housing
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_39.json');
    } catch (e) {
