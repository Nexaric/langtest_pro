...
class WritingLesson1 extends StatefulWidget {
  const WritingLesson1({super.key, required lessonData});

  @override
  State<WritingLesson1> createState() => _WritingLesson1State();
}

class _WritingLesson1State extends State<WritingLesson1>
...
While technology can overwhelm, its benefits outweigh drawbacks. Innovations like medical AI save lives, and remote work tools improve productivity. The key is mindful usage—setting screen-time limits or using ad-blockers to minimize distractions.

In conclusion, technology's convenience dominates when used responsibly. Rather than blaming devices, users should adapt habits to harness advantages without succumbing to pitfalls. (170 words)
''',
    'tips': '''
💡 Expert Tips
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_1.json');
    } catch (e) {
