...
class WritingLesson28 extends StatefulWidget {
  const WritingLesson28({super.key, required lessonData});

  @override
  State<WritingLesson28> createState() => _WritingLesson28State();
}

class _WritingLesson28State extends State<WritingLesson28>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Opinion Essay – AI in Healthcare',
...
AI enhances diagnostic accuracy and speed. In 2023, Google's DeepMind AI detected breast cancer with 90% accuracy, surpassing human radiologists, per a Lancet study. This reduces misdiagnoses, which affect 12 million patients annually, according to WHO. AI also streamlines operations; IBM's Watson cuts treatment planning time by 40% for oncologists, per a 2024 JAMA report. Additionally, AI-powered telemedicine serves 20% more patients in rural areas, per a 2023 World Bank study, improving access where doctors are scarce.

However, concerns exist. Data privacy is a significant risk; 30% of healthcare breaches in 2022 involved AI systems, per Verizon's Data Breach Report. Overreliance on AI may erode clinical judgment, with 25% of doctors reporting reduced confidence, per a 2023 AMA survey. Ethical issues, like biased algorithms, also persist; a 2022 Nature study found AI misdiagnosed 15% more non-white patients. High costs limit access, with AI systems costing 200,000 dollars annually, per a 2024 Deloitte report.

These risks can be mitigated. Stricter regulations, like the EU's AI Act, reduced breaches by 20% in 2024. Training doctors to use AI as a tool, not a replacement, maintains clinical skills. Addressing bias through diverse datasets, as piloted by Stanford, improves accuracy by 10%. Subsidies, like India's 100 million dollar AI healthcare fund, enhance affordability.

In conclusion, AI's diagnostic and efficiency benefits outweigh its risks, provided regulations and training are prioritized. Its potential to save lives makes it a positive force in healthcare.
''',
    'tips': '''
Expert Tips
...
4. Examples:
   - DeepMind's 90% cancer detection
   - Verizon's 30% breach statistic
   - EU's AI Act impact
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_28.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Illustration: AI-powered medical diagnostic concept',
