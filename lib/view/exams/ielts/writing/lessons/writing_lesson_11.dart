...
class WritingLesson11 extends StatefulWidget {
  const WritingLesson11({super.key, required lessonData});

  @override
  State<WritingLesson11> createState() => _WritingLesson11State();
}

class _WritingLesson11State extends State<WritingLesson11>
...
Poverty and healthcare demand urgent funding. UNICEF reports 356 million children live in extreme poverty, lacking basic nutrition. Allocating NASA’s \$24 billion annual budget could transform these lives through education and medical aid. Climate change also warrants investment—IPCC estimates \$100 billion annually could mitigate global warming’s worst effects. Space programs, conversely, offer speculative benefits like colonization, which remain decades away.

However, space exploration drives innovation. Satellite technology, developed through NASA, enables global communication and disaster monitoring, indirectly aiding Earth. The Apollo program’s advancements in computing revolutionized industries. Yet, these benefits are often overstated—private companies like SpaceX now lead innovation, reducing the need for public funding.

Balancing both is key. Governments could cap space budgets, redirecting surplus to immediate crises while maintaining research for long-term gains. For instance, India’s frugal Mars mission cost \$74 million, proving efficiency is possible.

In conclusion, Earth’s challenges—poverty, climate change, and health—require priority. Space exploration’s allure must not overshadow suffering millions. Strategic investment in both can ensure humanity’s progress without neglecting the present.
''',
    'tips': '''
💡 Expert Tips
...
4. Examples:
   - UNICEF’s 356M children in poverty
   - IPCC’s \$100B climate estimate
   - NASA’s \$24B budget
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_11.json');
    } catch (e) {
