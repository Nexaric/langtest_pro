...
class WritingLesson12 extends StatefulWidget {
  const WritingLesson12({super.key, required lessonData});

  @override
  State<WritingLesson12> createState() => _WritingLesson12State();
}

class _WritingLesson12State extends State<WritingLesson12>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Discussion Essay – Universal Basic Income',
...
Universal basic income (UBI) sparks debate as a poverty alleviation tool versus a disincentive to work. Proponents argue UBI provides a safety net, enabling dignity and opportunity. Finland's 2017 trial gave 2,000 unemployed citizens €560 monthly, reducing stress and boosting entrepreneurship. UBI could replace fragmented welfare systems, cutting bureaucracy—Alaska's Permanent Fund Dividend, funded by oil, distributes \$1,000–\$2,000 annually to residents, stabilizing incomes.
...
A balanced perspective suggests tiered or conditional UBI. Means-tested payments, like Brazil's Bolsa Família, lift millions from poverty while requiring school attendance, maintaining incentives. Automation's rise—Oxford predicts 47% of jobs at risk—makes UBI appealing to cushion displaced workers, but pilot programs must monitor labor market impacts.
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_12.json');
    } catch (e) {
