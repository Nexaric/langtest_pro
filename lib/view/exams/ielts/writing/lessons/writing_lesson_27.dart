...
class WritingLesson27 extends StatefulWidget {
  const WritingLesson27({super.key});

  @override
  State<WritingLesson27> createState() => _WritingLesson27State();
}

class _WritingLesson27State extends State<WritingLesson27>
...
Balancing these issues requires innovation. Hybrid models, like those in 60% of UK universities, combine online and in-person learning to boost engagement. Subsidized internet, as in India’s PM-WANI scheme, improves access for 20% of rural users. Proctoring software reduces cheating by 15%, per a 2024 ProctorU study.

In conclusion, online education’s accessibility and affordability are transformative, but engagement and equity challenges must be addressed. Hybrid approaches and infrastructure investments can maximize its potential.
''',
    'tips': '''
Expert Tips

1. Structure:
   - Introduction: Introduce online education’s rise
...
4. Examples:
   - Coursera’s 120M learners
   - Harvard’s 50% dropout rate
   - India’s PM-WANI scheme
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_27.json');
    } catch (e) {
