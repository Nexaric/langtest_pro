...
class WritingLesson10 extends StatefulWidget {
  const WritingLesson10({super.key, required lessonData});

  @override
  State<WritingLesson10> createState() => _WritingLesson10State();
}

class _WritingLesson10State extends State<WritingLesson10>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Two-Part Question – Aging Populations',
    'icon': Icons.elderly,
    'question':
...
Aging populations strain pension systems and healthcare. In Japan, 30% are over 65, forcing tax hikes on workers to fund retirees. Elderly care also faces staff shortages—the UK needs 1.1 million more caregivers by 2030.
...
Intergenerational solidarity is key. Policies like Sweden’s "life-long learning" initiatives retrain older workers, keeping them productive while mentoring youth.
''',
    'tips': '''
💡 Expert Tips
...
4. Examples:
   - Japan’s aging crisis (30% over 65)
   - UK’s caregiver shortage (1.1M by 2030)
   - Sweden’s life-long learning programs
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_10.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.elderly, color: Colors.blue[700]),
