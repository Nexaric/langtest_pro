...
class WritingLesson33 extends StatefulWidget {
  const WritingLesson33({super.key, required lessonData});

  @override
  State<WritingLesson33> createState() => _WritingLesson33State();
}

class _WritingLesson33State extends State<WritingLesson33>
...
Economically, automation boosts efficiency. In manufacturing, robots increased global output by 30% from 2010 to 2023, per the International Federation of Robotics. This reduces costs; Tesla's automated factories cut production expenses by 20%, per a 2024 Bloomberg report. Automation also creates high-skill jobs—Germany's tech sector grew 15% due to AI adoption, per a 2023 OECD study. Furthermore, it mitigates labor shortages; Japan's aging population relies on robots for 25% of elderly care, per a 2024 Nikkei report. These gains suggest automation could sustain economic growth amid demographic shifts.

However, job displacement is a formidable drawback. Low-skill workers face severe risks; 47% of U.S. jobs, particularly in retail and logistics, are automatable, per a 2023 Frey-Osborne study. This exacerbates unemployment—Spain's 2024 automation surge raised youth unemployment to 22%, per Eurostat. Socially, automation erodes job satisfaction; 60% of automated warehouse workers report alienation, per a 2023 Pew survey. Widening inequality is another concern; the top 1% captured 50% of automation-driven wealth gains, per a 2024 Oxfam report. Critics argue automation's benefits skew toward corporations, not workers.

Counterarguments suggest retraining mitigates job losses. Singapore's SkillsFuture program reskilled 20% of its workforce for tech roles by 2024, per government data. Yet, retraining is costly—10,000 per worker, per a 2023 ILO estimate—and inaccessible for many in developing nations. Automation's social costs, like mental health declines linked to job insecurity, affecting 30% of displaced workers per a 2024 WHO study, remain underaddressed.

In conclusion, automation's productivity gains are undeniable, but its social and economic tolls—unemployment, inequality, and alienation—demand robust policies. Universal basic income, as trialed in Finland, and accessible retraining can balance these impacts, ensuring automation serves humanity broadly.
''',
    'tips': '''
Expert Tips

1. Structure:
   - Introduction: Highlight automation's transformative role
...
4. Examples:
   - Tesla's 20% cost reduction
   - Spain's 22% youth unemployment
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_33.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Illustration: Robotic automation concept',
