...
class WritingLesson5 extends StatefulWidget {
  const WritingLesson5({super.key, required lessonData});

  @override
  State<WritingLesson5> createState() => _WritingLesson5State();
}

class _WritingLesson5State extends State<WritingLesson5>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Two-Part Question – Environment',
    'icon': Icons.eco,
    'question':
...
Human activities like deforestation and pollution drive species extinction. Logging destroys habitats, while plastics harm marine life—for instance, sea turtles mistaking bags for jellyfish.
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_5.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.eco, color: Colors.blue[700]),
