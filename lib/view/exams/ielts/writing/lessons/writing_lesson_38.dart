...
class WritingLesson38 extends StatefulWidget {
  const WritingLesson38({super.key});

  @override
  State<WritingLesson38> createState() => _WritingLesson38State();
}

class _WritingLesson38State extends State<WritingLesson38>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Advantages/Disadvantages – Artificial Intelligence',
    'icon': Icons.computer,
    'question':
...
AI’s advantages are profound. In healthcare, AI diagnostics, like Google’s DeepMind, detect diseases with 94% accuracy, per a 2024 Lancet study, improving patient outcomes. In industry, automation boosts efficiency; AI-driven manufacturing increased global productivity by 15%, per a 2023 IMF report. Education benefits from personalized learning—AI platforms like Duolingo raised student engagement by 30%, per a 2024 UNESCO study. Additionally, AI enhances environmental management; predictive models reduced energy waste by 20% in smart grids, per a 2023 IEA report. These advancements drive innovation, economic growth, and sustainability.

However, AI’s disadvantages are equally concerning. Job displacement is a major issue; 30% of current roles could be automated by 2030, per a 2023 McKinsey study, risking unemployment for millions. Ethical concerns, such as bias, persist—AI facial recognition misidentified minorities 35% more often than others, per a 2024 NIST report. Privacy erosion is another challenge; 60% of consumers fear data misuse by AI systems, per a 2023 Pew survey. Moreover, AI’s potential misuse in autonomous weapons raises security risks, with 70% of UN members advocating regulation, per a 2024 UN report. These drawbacks highlight the need for robust governance.

Critics argue AI’s benefits outweigh its risks, citing historical adaptation to technological shifts, like the Industrial Revolution, which created new jobs. Yet, AI’s rapid pace and ethical complexities differ, demanding proactive measures like reskilling programs, which reduced job loss impacts by 25% in Germany, per a 2023 OECD study. Conversely, overregulation could stifle innovation; China’s lenient AI policies spurred a 1 trillion market by 2024, per Bloomberg.

In conclusion, AI’s advantages in healthcare, industry, and sustainability are transformative, but job displacement, bias, and privacy risks require stringent oversight. Balanced regulation and reskilling can maximize AI’s potential while mitigating its harms.
''',
    'tips': '''
Expert Tips

1. Structure:
   - Introduction: Introduce AI’s role, outline benefits and risks
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_38.json');
    } catch (e) {
