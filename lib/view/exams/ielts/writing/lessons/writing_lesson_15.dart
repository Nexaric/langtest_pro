...
class WritingLesson15 extends StatefulWidget {
  const WritingLesson15({super.key, required lessonData});

  @override
  State<WritingLesson15> createState() => _WritingLesson15State();
}

class _WritingLesson15State extends State<WritingLesson15>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Two-Part Question – Artificial Intelligence',
...
Artificial intelligence (AI) revolutionizes industries, offering immense benefits alongside notable risks. Its advantages include enhanced efficiency and innovation. In healthcare, AI diagnostics, like IBM Watson, detect cancer with 90% accuracy, surpassing human specialists. Automation streamlines manufacturing—Tesla’s AI-driven factories cut production costs by 30%. AI also personalizes education; platforms like Duolingo adapt lessons, boosting retention by 12%, per studies.

However, AI poses risks, including job displacement and ethical concerns. Oxford estimates 47% of jobs, such as trucking, face automation threats, potentially widening inequality. Privacy issues loom—China’s AI surveillance tracks 1.4 billion citizens, raising dystopian fears. Bias in AI algorithms, as seen in Amazon’s scrapped AI hiring tool that favored men, underscores fairness challenges.

Mitigating risks requires proactive governance. Governments should invest in reskilling programs, like Germany’s Industry 4.0 initiative, which retrains workers for tech roles. Ethical AI frameworks, such as the EU’s AI Act, mandate transparency and accountability. Public-private collaboration can ensure AI serves humanity equitably.

In conclusion, AI’s transformative potential must be balanced against its risks. Strategic policies and ethical oversight can harness its benefits while safeguarding society.
''',
    'tips': '''
💡 Expert Tips

1. Structure:
   - Introduction: Introduce AI’s impact
...
4. Examples:
   - IBM Watson’s 90% cancer detection
   - Tesla’s 30% cost reduction
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_15.json');
    } catch (e) {
