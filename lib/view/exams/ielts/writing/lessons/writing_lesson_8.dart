...
class WritingLesson8 extends StatefulWidget {
  const WritingLesson8({super.key, required lessonData});

  @override
  State<WritingLesson8> createState() => _WritingLesson8State();
}

class _WritingLesson8State extends State<WritingLesson8>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Advantages/Disadvantages – Fast Food',
    'icon': Icons.fastfood,
    'question':
...
While fast food won't disappear, balanced policies—like mandatory nutrition labeling and fair wages—can mitigate its harms while preserving economic benefits.
''',
    'tips': '''
💡 Expert Tips
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_8.json');
    } catch (e) {
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: Colors.red[800], // Fast food theme color
            ),
          ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.fastfood, color: Colors.red[700]),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.red[700], // Fast food theme color
