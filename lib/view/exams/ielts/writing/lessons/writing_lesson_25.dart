...
class WritingLesson25 extends StatefulWidget {
  const WritingLesson25({super.key, required lessonData});

  @override
  State<WritingLesson25> createState() => _WritingLesson25State();
}

class _WritingLesson25State extends State<WritingLesson25>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Opinion Essay – Social Media Influence',
    'icon': Icons.phone_iphone,
    'question':
        'Social media influences people’s opinions and behaviors. Is this a positive or negative development?',
    'sampleAnswer': '''
Sample Answer (310 words)

Social media’s pervasive influence on opinions and behaviors is a double-edged sword. While it fosters connectivity and awareness, its negative impacts, such as misinformation and polarization, outweigh the benefits, making it a largely detrimental development.

On the positive side, social media amplifies voices and spreads knowledge. Platforms like Twitter enable grassroots movements, such as #MeToo, which reached 19 million users in 2017, per Pew Research, promoting social justice. Educational content on YouTube, viewed by 70% of Gen Z for learning, per a 2023 Google report, enhances accessibility to information. Additionally, social media connects communities, with 65% of global users reporting stronger ties, according to a 2022 Statista survey.

However, the drawbacks are profound. Misinformation proliferates rapidly; a 2021 MIT study found false stories spread six times faster than accurate ones, misleading 30% of users on health issues, per WHO. Social media also fuels polarization. Algorithms on Facebook prioritize divisive content, increasing political extremism by 20%, according to a 2023 NYU study. Furthermore, excessive use impacts mental health, with 25% of teens reporting anxiety linked to Instagram, per a 2022 American Psychological Association report. Cyberbullying, affecting 40% of young users per a 2024 UNICEF study, exacerbates this.

Mitigating these issues requires regulation and education. Governments, like the EU’s Digital Services Act, are enforcing content moderation, reducing harmful posts by 15%. Media literacy programs, adopted in 60% of Australian schools, empower users to discern credible information.
...
1. Structure:
   - Introduction: State stance on social media’s influence
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_25.json');
    } catch (e) {
