...
class WritingLesson7 extends StatefulWidget {
  const WritingLesson7({super.key, required lessonData});

  @override
  State<WritingLesson7> createState() => _WritingLesson7State();
}

class _WritingLesson7State extends State<WritingLesson7>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Discussion Essay – Healthcare',
...
4. Examples:
   ...
   - Germany’s hybrid insurance system
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_7.json');
    } catch (e) {
