...
class WritingLesson22 extends StatefulWidget {
  const WritingLesson22({super.key, required lessonData});
...
class _WritingLesson22State extends State<WritingLesson22>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Discussion Essay – Minimum Wage Laws',
...
Conversely, small businesses face significant burdens. Higher wages increase operating costs, particularly for labor-intensive industries like hospitality. A 2023 UK study found that 30% of small retailers cut staff hours or jobs after a 10% wage hike. In competitive markets, businesses may pass costs to consumers, raising prices—fast-food prices in California rose 7% post-wage increases. Alternatively, some firms, lacking profit margins, risk closure; 15% of U.S. small businesses reported reduced viability after wage hikes, per the NFIB.

Balancing these impacts requires nuanced policies. Gradual wage increases, as in Australia’s tiered system, allow businesses to adapt. Tax credits or subsidies for small firms, like Canada’s SME relief program, offset costs, preserving jobs. Training programs can boost worker skills, justifying higher pay without straining employers.
...
4. Examples:
   - U.S. CBO’s 1.3M poverty reduction
   - UK’s 30% staff cuts
   - Canada’s SME relief program
''',
  };
