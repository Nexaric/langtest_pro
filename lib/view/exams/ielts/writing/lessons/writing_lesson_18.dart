...
class WritingLesson18 extends StatefulWidget {
  const WritingLesson18({super.key, required lessonData});

  @override
  State<WritingLesson18> createState() => _WritingLesson18State();
}

class _WritingLesson18State extends State<WritingLesson18>
  ...
  final Map<String, dynamic> _task = {
    ...
    'sampleAnswer': '''
📝 Sample Answer (265 words)

International tourism drives economic growth but threatens cultural integrity. Its advantages are substantial. Tourism generates revenue—Thailand’s 2019 tourism sector contributed 18% to GDP, creating 7 million jobs. It fosters cross-cultural exchange; programs like Japan’s homestays promote mutual understanding. Infrastructure improvements, such as Bali’s upgraded airports, benefit locals beyond tourism.

Conversely, tourism can erode traditions and environments. Over-tourism in Venice, with 30 million annual visitors, strains infrastructure and displaces residents. Cultural commodification, like Bali’s sacred dances performed for profit, dilutes authenticity. Environmental degradation is rampant—Australia’s Great Barrier Reef lost 50% of its coral due to tourist activity, per UNESCO.

Sustainable tourism offers a solution. Regulations, like Bhutan’s high-value, low-impact model, limit visitors while preserving culture, with 70% of revenue funding conservation. Community-based tourism, as in Costa Rica, empowers locals, with 80% of eco-lodges locally owned. Education campaigns can encourage respectful visitor behavior.

In conclusion, tourism’s economic benefits must be weighed against cultural and environmental costs. Sustainable practices can harmonize prosperity with preservation.
''',
    'tips': '''
💡 Expert Tips

1. Structure:
   - Introduction: Outline tourism’s dual impact
...
4. Examples:
   - Thailand’s 18% GDP from tourism
   - Venice’s 30M visitors
   - Bhutan’s sustainable model
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_18.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.flight_takeoff, color: Colors.blue[700]),
