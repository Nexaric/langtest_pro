...
class WritingLesson4 extends StatefulWidget {
  const WritingLesson4({super.key, required lessonData});

  @override
  State<WritingLesson4> createState() => _WritingLesson4State();
}

class _WritingLesson4State extends State<WritingLesson4>
...
Solutions include improving alternatives. Governments could invest in metro systems, as seen in Tokyo, where punctual trains reduce car use. Congestion pricing, like London’s fee for driving downtown, also discourages unnecessary trips.
...
4. Examples:
   - Tokyo’s metro system reducing car use
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_4.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.traffic, color: Colors.blue[700]),
