...
class WritingLesson9 extends StatefulWidget {
  const WritingLesson9({super.key, required lessonData});

  @override
  State<WritingLesson9> createState() => _WritingLesson9State();
}

class _WritingLesson9State extends State<WritingLesson9>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Problem/Solution – Youth Unemployment',
    'icon': Icons.work_off,
    'question':
...
Solutions require education reform and private sector cooperation. Vocational training aligned with market needs—Germany's dual education system halves youth unemployment by pairing classroom learning with paid internships. Governments could also subsidize startups; Chile’s "Start-Up Chile" program created 5,000 jobs by funding young entrepreneurs.
...
4. Examples:
   - Spain’s 35% youth unemployment
   - Germany’s dual education system
   - Chile’s "Start-Up Chile" program
''',
  };
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_9.json');
    } catch (e) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.work_off, color: Colors.blue[700]),
