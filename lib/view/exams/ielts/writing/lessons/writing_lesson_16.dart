...
class WritingLesson16 extends StatefulWidget {
  const WritingLesson16({super.key, required lessonData});

  @override
  State<WritingLesson16> createState() => _WritingLesson16State();
}

class _WritingLesson16State extends State<WritingLesson16>
  ...
  final Map<String, dynamic> _task = {
    'title': 'Opinion Essay – Censorship in Media',
    'icon': Icons.gavel,
    'question':
...
Misinformation spreads rapidly, as seen in the 2020 COVID-19 pandemic, where false remedies reached millions via social media, per WHO. Censorship advocates argue it protects public safety. China’s Great Firewall, for instance, filters content, claiming to maintain social stability. Yet, this often masks authoritarian control—China’s 2023 media crackdown silenced dissent, not just falsehoods.

Free speech, conversely, is a cornerstone of democracy. It fosters debate and accountability, as evidenced by the Pentagon Papers, which exposed government deceit. Censorship risks overreach; the UK’s 2021 Online Safety Bill sparked fears of vague “harmful content” definitions stifling expression. Even well-intentioned controls can erode trust—62% of Americans distrust government-led censorship, per Pew Research.

Alternatives exist. Media literacy programs, like Finland’s, reduce misinformation by teaching critical thinking, with 80% of students showing improved source evaluation. Tech firms should enhance fact-checking, as X’s Community Notes do, crowdsourcing corrections.
...
4. Examples:
   - WHO’s 2020 misinformation data
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_16.json');
    } catch (e) {
