...
class FormalLetterLesson5 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const FormalLetterLesson5({super.key, required this.lessonData});

  @override
  State<FormalLetterLesson5> createState() => _FormalLetterLesson5State();
}

class _FormalLetterLesson5State extends State<FormalLetterLesson5>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'Your friend is applying for a job at a company where you work. Write a letter to your manager recommending your friend for the position.',
    'sampleAnswer': '''
📝 Sample Answer

Dear Mr. Richards,

I am writing to recommend my friend, Sarah Collins, who has recently applied for the open position of Graphic Designer in our department.

I have known Sarah for over five years, and we worked together on several freelance projects. She is highly skilled in Adobe Creative Suite and has an exceptional eye for detail and creativity. I am confident she would be a valuable addition to our team.

Please let me know if you would like to see her portfolio or need further information about her qualifications.
...
1. Structure:
   - Sender Address: Optional, depending on context
   - Date: Below your address or at the start
   - Receiver Address: Manager’s name or title
   - Salutation: Use "Dear [Manager’s Name]" or "Dear Sir/Madam"
   - Body: Introduce friend, highlight skills, offer follow-up
...
3. Content:
   - State the position and your relationship with the candidate
   - Highlight specific skills or experiences
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/formal_letter_5.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Excellent recommendation letter! Your letter is professional, persuasive, and well-structured.";
    } else if (score >= 6.0) {
      return "Good effort. Include more specific skills or maintain a formal tone.";
    } else {
      return "Needs improvement. Focus on highlighting relevant qualifications and a confident tone.";
    }
  }
