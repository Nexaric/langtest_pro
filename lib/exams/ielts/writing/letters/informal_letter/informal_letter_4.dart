...
class InformalLetterLesson4 extends StatefulWidget {
  ...
  const InformalLetterLesson4({super.key, required this.lessonData});

  @override
  State<InformalLetterLesson4> createState() => _InformalLetterLesson4State();
}
...
class _InformalLetterLesson4State extends State<InformalLetterLesson4>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'Your friend is nervous about a job interview. Write a letter to give them advice and encouragement.',
    'sampleAnswer': '''
📝 Sample Answer

Hi Alex,

I heard about your job interview—how exciting! Don’t be nervous; you’ve got this!

My advice? Practice some common questions and be yourself—they’ll love your energy. Also, make sure to research the company a bit. Oh, and wear that blue shirt; it’s super sharp! Just take a deep breath and go for it.
...
1. Structure:
   ...
   - Opening: Acknowledge their situation and offer support
   - Body: Share specific, practical advice
   - Closing: Encourage them and ask for an update, sign off casually
...
3. Content:
   - Offer clear, actionable advice (e.g., preparation tips)
   - Include positive encouragement to boost confidence
   - Personalize the advice to make it relevant
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/informal_letter_4.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Excellent advice! Your letter is supportive, clear, and boosts confidence.";
    } else if (score >= 6.0) {
      return "Good effort. Offer more specific advice or add stronger encouragement.";
    } else {
      return "Needs improvement. Focus on actionable advice and a supportive tone.";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'IELTS Writing: Informal Letter 4',
