...
class InformalLetterLesson5 extends StatefulWidget {
  final Map<String, dynamic> lessonData;

  const InformalLetterLesson5({super.key, required this.lessonData});

  @override
  State<InformalLetterLesson5> createState() => _InformalLetterLesson5State();
}

class _InformalLetterLesson5State extends State<InformalLetterLesson5>
  ...
  final Map<String, dynamic> _task = {
    ...
    'icon': Icons.edit,
    'question':
        'You recently got a new job. Write a letter to a friend to share the good news and tell them about it.',
    'sampleAnswer': '''
📝 Sample Answer

Hey Sarah,

Guess what? I just landed a new job at a marketing firm! I’m so excited!

It’s a junior designer role, starting next month. The team seems awesome, and I’ll get to work on some cool projects. I was super nervous during the interview, but it paid off! Want to celebrate over dinner this weekend?
...
1. Structure:
   ...
   - Opening: Introduce the good news excitedly
   - Body: Share details about the news (e.g., job role, start date)
   - Closing: Suggest meeting up and sign off casually

2. Tone:
   - Be enthusiastic, positive, and friendly
   - Use conversational language and contractions

3. Content:
   - Clearly state the news and why it’s exciting
   - Include specific details to make it engaging
   - Invite them to celebrate or catch up
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _letterFile = File('$_storagePath/informal_letter_5.json');
    } catch (e) {
  ...
  String _generateFeedback(double score) {
    if (score >= 8.0) {
      return "Fantastic letter! Your excitement and details make the news engaging.";
    } else if (score >= 6.0) {
      return "Good effort. Add more specific details or a livelier tone.";
    } else {
      return "Needs improvement. Focus on a positive tone and clear details.";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'IELTS Writing: Informal Letter 5',
