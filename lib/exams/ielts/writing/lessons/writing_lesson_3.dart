...
class WritingLesson3 extends StatefulWidget {
  const WritingLesson3({super.key});

  @override
  State<WritingLesson3> createState() => _WritingLesson3State();
}

class _WritingLesson3State extends State<WritingLesson3>
...
''',
  ...
  Future<void> _initStorage() async {
    try {
      ...
      _essayFile = File('$_storagePath/essay_response_3.json');
    } catch (e) {
