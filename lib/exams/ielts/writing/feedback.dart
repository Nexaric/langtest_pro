...
class FeedbackScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final writingProgress = progressProvider.completedLessons;
    final letterProgress = progressProvider.completedLetterLessons;
    final totalProgress = writingProgress + letterProgress;
    final totalLessons = WritingProgressProvider.totalLessons;
                      ...
                      children: [
                        Expanded(
                          child: _buildProgressCard(
                            "Writing Lessons",
                            "$writingProgress / ${WritingProgressProvider.totalWritingLessons}",
                            Colors.blueAccent,
                          ),
                        ),
                        ...
                        Expanded(
                          child: _buildProgressCard(
                            "Letter Lessons",
                            "$letterProgress / ${WritingProgressProvider.totalLetterLessons}",
                            Colors.greenAccent,
                          ),
                        ),
                      ],
