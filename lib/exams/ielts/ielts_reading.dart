...
import 'package:langtest_pro/exams/ielts/reading/general/general_lessons.dart';
import 'package:provider/provider.dart';
import 'package:langtest_pro/exams/ielts/reading/academic/academic_lessons.dart';
import 'package:langtest_pro/exams/ielts/reading/feedback.dart';
import 'package:langtest_pro/exams/ielts/reading/strategies_tips.dart';
...
class IeltsReadingScreen extends StatelessWidget {
  ...
  Widget _buildHeader(BuildContext context) {
    ...
    final progress =
        (progressProvider.completedAcademicLessons +
            progressProvider.completedGeneralLessons) /
        ReadingProgressProvider.totalLessons;
