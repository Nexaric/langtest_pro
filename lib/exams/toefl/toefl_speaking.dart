...
class ToeflSpeakingScreen extends StatelessWidget {
  const ToeflSpeakingScreen({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionCard(
                  ...
                  "Respond to a given topic with your opinion.",
                  Colors.orange,
                ),
                _buildSectionCard(
                  context,
                  "📖 Integrated Speaking Task",
                  "Speak based on a given reading or listening passage.",
                  Colors.green,
                ),
                _buildSectionCard(
                  context,
                  "🗣 AI Pronunciation Feedback",
                  "Receive real-time feedback on fluency and pronunciation.",
                  Colors.blueAccent,
                ),
                _buildSectionCard(
                  context,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Practice with AI, enhance fluency, and prepare for the TOEFL exam.",
